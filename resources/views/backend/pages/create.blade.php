    ...
    <div class="col-md-12">
        <div class="widget-wrap">
            <div class='widget-container'>
                ...
                <form class="form-horizontal j-forms" method="POST" action="{{ route('admin.page.store') }}">
                    {!! csrf_field() !!}
                    <div class="clearfix">
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="vi">
                            	<div class="unit">
	                            	...
	                            	<div class="input">
				                        <div>
				                            <input type="text" class="form-control" placeholder="Tiêu đề trang" name="name" autofocus required>
				                        </div>
				                    </div>
				                </div>
				                <div class="unit">
                            ...
                            <div role="tabpanel" class="tab-pane" id="en">
                            	<div class="unit">
	                            	...
	                            	<div class="input">
				                        <div>
				                            <input type="text" class="form-control" placeholder="The page title" name="name_en">
				                        </div>
				                    </div>
				                </div>
				                <div class="unit">
